...
data_root = '/user-data/split_ss_dota1_0/'
img_norm_cfg = dict(
...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        task='Task1',
#         ann_file='/user-data/isprs_split_ss_dota1_0/test/annfiles',
#         img_prefix='/user-data/isprs_split_ss_dota1_0/test/images',
        ann_file='/user-data/final_test_split_ss_dota1_0/test/annfiles',
        img_prefix='/user-data/final_test_split_ss_dota1_0/test/images',
        pipeline=test_pipeline))
evaluation = None
